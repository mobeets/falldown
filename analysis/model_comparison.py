...
# %%
def compare_all_models(data_dir="../data/cloud_study",
    ...
    # 2. Scan data/cloud_study/ for any files not in the hardcoded set
    data_dir_abs = Path(__file__).resolve().parent.parent / "data" / "cloud_study"
    extra_data = []
